...
export const spriteDefinitions: Record<string, SpriteDef> = {
    ...
    boss_kraken: {
        ...
        palette: { 
            ...
            'Q': '#722791', // medium Body (dithering)
        ...
        data: [
            ...
            ".......DDMMMQMMMMMMMMDD.........",
            "......DMMMMMMMMMQMMMMMMD........",
            ".....DMMQMMMMMMMMMMMQMMMD.......",
            "....DMMMMMMQMMMMMMMMMMMMMD......",
            "...DMMMMMMMMMMMMMMMQMMMMMMD.....",
            "...DMMMMMMMMMMMMMMMMMMMMMMD.....",
            "..DMMMMMMMMMMQMMMMMMMMMMMMMD....",
            "..DMMMMMMQMMMMMMMMMMMMMMMMMD....",
            ".DMMMMMMMMMMMQMMMMMMQMMMMMMMD...",
            ".DMMMMMMMQMMMMMMMMMMMMMQMMMMD...",
            ".DMMMMMEEEEEEMMMMEEEEEEMMMQMD...",
            ".DMQMMEEEEEEEEMMEEEEEEEEQMMMD...",
            ".DMMMMEPPPPPPEMMEPPPPPPEMMQMD...",
            ".DMMMMEPPPPPPEMMEPPPPPPEMMMMD...",
            ".DMMMMEPPPPPPEMMEPPPPPPEMMMQD...",
            ".DMMMQEEEEEEEEMMEEEEEEEEMMMMD...",
            ".DMQMMMEEEEEEMMMMEEEEEEMMMMMD...",
            ".DMMMMMMMMMMMMMMMMMMQMMMMMMMD...",
            ".DMMMMQMMMMMMMMMMQMMMMMMMQMMD...",
            ".DMMMMMMMMMMMMMMMMMMMMMMMMMMD...",
            "..DMMMMMMMMMQMMMMMMMMMMQMMMD....",
            "..DMMMMMQMMMMMMMMMQMMMMMMMMD....",
            "...DMMMMMMMMMMMMMMMMMMMMMMD.....",
            "...DMMMMMMMMMMMMQMMMMMMMMMD.....",
            "....DMMMMMMQMMMMMMMMMMMMMD......",
            ".....DMMMMMMMMMQMMMMMQMMMD.......",
            "......DDMMMMMMMMMQMMMMDD........",
            "........DDDMQMMMMMMDDD..........",
            "...........DDDDDDDD.............",
            "................................"
